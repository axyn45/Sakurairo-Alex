...
?>
	<section class="author-profile">
		<div class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
			<a href="<?= esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" class="profile gravatar"><img src="<?php echo get_avatar_url(get_the_author_meta( 'ID' )); ?>" itemprop="image" alt="<?php the_author(); ?>" height="70" width="70"></a>
			<div class="meta">
